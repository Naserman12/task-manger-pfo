...
@section('content')
<div>  
    <div class="w-full bg-gradient-to-r from-orange-950 to-orange-400 mt-4 max-w-md  bg-white  p-8 rounded-lg shadow-md">
    <h2 class="text-2xl font-bold bg-blue-500 text-center text-gray-800 mb-6">تسجيل جديد</h2>
